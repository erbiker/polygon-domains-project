const main = async () => {
    ...
    const domainContract = await domainContractFactory.deploy("doc");
    ...
    //txn = await domainContract.register("thisdomainistoolong",  {value: hre.ethers.utils.parseEther('1234')});
    //await txn.wait();

    //unauthorized error
    //txn = await domainContract.connect(superCoder).setRecord("a16z", "record");
    //await txn.wait();
